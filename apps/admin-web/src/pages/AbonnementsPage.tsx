  ...
  return (
    <div className="p-6 space-y-6">
      ...
      <div className="grid grid-cols-4 gap-4">
        {[
          { label: 'Gratuit', count: parAbonnement.GRATUIT, color: 'gray', icon: '🆓' },
          { label: '2-5 motos', count: parAbonnement['2_5'], color: 'blue', icon: '🥈' },
          { label: '6-10 motos', count: parAbonnement['6_10'], color: 'purple', icon: '🥇' },
          { label: '11+ motos', count: parAbonnement['11_PLUS'], color: 'amber', icon: '💎' },
        ].map((s, i) => (
